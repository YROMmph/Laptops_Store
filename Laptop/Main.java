...
public class Main {
    public static void main(String[] args) {
        ...
        laptops.add(new Laptop("Apple", 8, 512, "MacOS", "White"));
        laptops.add(new Laptop("Lenovo", 32, 1024, "Windows", "Gray"));
        laptops.add(new Laptop("Lenovo", 32, 2048, "Windows", "Black"));
        laptops.add(new Laptop("Lenovo", 32, 1024, "Windows", "White"));
        laptops.add(new Laptop("Lenovo", 32, 2048, "Windows", "Gold"));
        laptops.add(new Laptop("HP", 12, 512, "Windows", "White"));
        laptops.add(new Laptop("Asus", 16, 1024, "Windows", "Blue"));
        laptops.add(new Laptop("Asus", 16, 1024, "Windows", "Black"));
        laptops.add(new Laptop("Acer", 8, 512, "Windows", "Red"));
        laptops.add(new Laptop("Acer", 16, 2048, "Windows", "Black"));
        laptops.add(new Laptop("Acer", 16, 2048, "Windows", "Black"));
